        ...
        <Section id='intro'>
            <Grid container spacing={0}>
                <Grid item xs={6} sx={{
                    ...
                    <Typography variant='subtitle1'>I am an undergraduate at the Indian Institute of Information Technology Guwahati majoring in Computer Science and Engineering. You can learn more about me by scrolling below.</Typography>
                    <Box sx={{
                        display: 'flex',
